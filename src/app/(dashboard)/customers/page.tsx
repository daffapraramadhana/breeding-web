...
export default function CustomersPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      toast.error(
        editingCustomer ? tc('entityUpdateFailed', { entity: t('entity') }) : tc('entityCreateFailed', { entity: t('entity') })
      );
    } finally {
    ...
    <div className="space-y-6">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editingCustomer ? tc('editEntity', { entity: t('entity') }) : tc('newEntity', { entity: t('entity') })}
            </DialogTitle>
            <DialogDescription>
              {editingCustomer
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                type="number"
                placeholder={tc('enterFieldOptional', { field: t('creditLimit') })}
      ...
      <ConfirmDialog
        ...
        description={tc('confirmDelete', { name: deletingCustomer?.name ?? '' })}
